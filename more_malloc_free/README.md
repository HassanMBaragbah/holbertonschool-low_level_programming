...
| **100** | `100-realloc.c` | Reallocates a memory block using `malloc` and `free`. | <ul><li>[x] Completed</li></ul> |
| **101** | `101-mul.c` | Multiplies two positive big numbers passed as command line arguments. | <ul><li>[x] Completed</li></ul> |
