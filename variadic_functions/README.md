...
| :---: | --- | --- | --- |
| **0** | `0-sum_them_all.c` | Returns the sum of all its parameters. Returns 0 if `n == 0`. | <ul><li>[ ] In Progress</li></ul> |
| **1** | `1-print_numbers.c` | Prints numbers, followed by a new line. | <ul><li>[ ] In Progress</li></ul> |
