...
| :---: | --- | --- | --- |
| **0** | `0-print_name.c` | Writes a function that prints a name using a function pointer. | <ul><li>[ ] In Progress</li></ul> |
| **1** | `1-array_iterator.c` | Executes a function given as a parameter on each element of an array. | <ul><li>[ ] In Progress</li></ul> |
| **2** | `2-int_index.c` | Searches for an integer in an array using a comparison function. | <ul><li>[ ] In Progress</li></ul> |
