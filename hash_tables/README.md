...
| **100** | `100-sorted_hash_table.c` | *(Advanced)* Implements a PHP-like sorted hash table (`shash_table_t`) using a doubly linked list to preserve order. | <ul><li>[x] Completed</li></ul> |
