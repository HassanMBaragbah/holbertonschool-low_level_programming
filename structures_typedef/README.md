...
| :---: | --- | --- | --- |
| **0** | `dog.h` | Define a new type `struct dog` with elements: `name`, `age`, and `owner`. | <ul><li>[ ] In Progress</li></ul> |
| **1** | `1-init_dog.c` | Write a function that initializes a variable of type `struct dog`. | <ul><li>[ ] In Progress</li></ul> |
| **2** | `2-print_dog.c` | Write a function that prints a `struct dog`. | <ul><li>[ ] In Progress</li></ul> |
| **3** | `dog.h` | Define a new type `dog_t` as a new name for `struct dog`. | <ul><li>[ ] In Progress</li></ul> |
